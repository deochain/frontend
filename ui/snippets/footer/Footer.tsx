      ...
      return (
        <Box gridArea={gridArea}>
          ...
          <Text mt={3} fontSize="xs">
            Inertia is a next-generation blockchain explorer built for Ethereum
            and EVM-compatible networks, offering a clear, real-time window into
            the decentralized world. Whether you're tracking transactions,
            exploring smart contracts, or diving into token movements, Inertia
            turns complex blockchain data into a beautifully simple experience.
          </Text>
    ...
    return (
      <Box {...containerProps}>
        <Grid {...contentProps}>
          ...
          >
            {[
              { title: "Social", links: BLOCKSCOUT_LINKS },
              ...(linksData || []),
            ]
              .slice(0, colNum)
              .map((linkGroup) => (
