...
const Icon = (props: IconProps) => {
  ...
  console.log("src2", props);
  props.token.icon_url = `https://raw.githubusercontent.com/rajneeshNadcab/inertia-images/main/icons/${props.token.address}/icon.png`;
...
const TokenEntity = (props: EntityProps) => {
  ...
  console.log("proptypes1");
  partsProps.icon.token.icon_url = `https://raw.githubusercontent.com/rajneeshNadcab/inertia-images/main/icons/${partsProps.icon.token.address}/icon.png`;
